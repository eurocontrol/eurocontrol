...
where `XXXX` is something like `PRU_DEV`, `PRU_DEV`, `PRU_PROD`, ... as defined in the AIU.
...
For example for the flight list of March 2023 you can run (you need access and
setup for `PRU_READ` schema):
